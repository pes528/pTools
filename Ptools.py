...
if __name__ == "__main__":
    ...
    conect = subprocess.run(["ping", "-c", "1", "www.google.com"], capture_output=True, text=True)

    run = lambda : asyncio.run(main()) if conect.stderr == "" else print("NO TIENES ACCESO A INTERNET")
    run()
